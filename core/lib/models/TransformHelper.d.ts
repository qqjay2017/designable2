...
export declare type TransformHelperType = 'translate' | 'resize' | 'rotate' | 'scale' | 'round';
export declare type ResizeDirection = 'left-top' | 'left-center' | 'left-bottom' | 'center-top' | 'center-bottom' | 'right-top' | 'right-bottom' | 'right-center' | (string & {});
