...
var Event = /** @class */ (function (_super) {
    ...
    function Event(props) {
        ...
        _this.drivers = [];
        _this.containers = [];
        if (types_1.isArr(props === null || props === void 0 ? void 0 : props.effects)) {
            props.effects.forEach(function (plugin) {
                plugin(_this);
            });
        }
        if (types_1.isArr(props === null || props === void 0 ? void 0 : props.drivers)) {
