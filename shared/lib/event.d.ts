...
export declare type EventOptions = boolean | (AddEventListenerOptions & EventListenerOptions & {
...
export declare class EventDriver<Engine extends Event = Event, Context = any> implements IEventDriver {
    ...
    subscribe<T extends ICustomEvent<any> = any>(subscriber: ISubscriber<T>): () => void;
    subscribeTo<T extends CustomEventClass>(type: T, subscriber: ISubscriber<InstanceType<T>>): () => void;
    subscribeWith<T extends ICustomEvent = ICustomEvent>(type: string | string[], subscriber: ISubscriber<T>): () => void;
    attach(container: EventDriverContainer): void;
    detach(container: EventDriverContainer): void;
